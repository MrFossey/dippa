...
Execution traces are simply full text accounts of test results. These include information which case failed, which is why tests should only have one assertion if possible \citep{duvall2008continuous}
