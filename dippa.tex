...
% The evaluation of the applicability of the reference model to the case organization was conducted by arranging a workshop where all developers currently involved in maintenance and other internal stakeholders were invited. In addition to the evaluation, the second objective of the workshop was to elicit ideas on how to improve the model
