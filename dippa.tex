...
\begin{enumerate}
\item \textbf{Plan coverage and relevant measures beforehand.}
...
\item\textbf{ Draw call graph to visualize integrations.}
...
See figures 6 and 7.
\begin{enumerate} 
\item Installing Jenkins is easy. Just download the war-package and deploy it on the test machine. Follow the instructions at http://jenkins-ci.org/. Afterwards open Jenkins at localhost:8080.
