...
%FIXME
Models made in the design phase can be used to manage testing. Typically, a system is formalized as a finite-state machine and pictured as a network. Then tests are run so that the whole network is traversed. Every transition from state to state is tested and model-based testing is usually used to test systems with very high availability requirements, like banking or medical systems.
