...
Ohjelmistot rakentuvat useiden komponenttien ja järjestelmien yhteustoiminnan kautta. Näiden liittymien ja rajapintojen toimivuus ja toimintavarmuus on tärkeää. Tämä diplomityö tutkii mitä automatisoidulta integraatiotestaukselta edellytetään ja perustuen kohdeyrityksen vaatimuksiin, minkälainen toimintatapa pystyy vastaamaan testaustarpeeseen.

Tutkimus pureutui ohjelmsitotestausmalleihin ja -teorioihin. Se tarkasteli olemassa olevia testikehyksiä ja perusteellisesti selvitti mistä osista kehykset koostuvat. Näistä käytännön ja testausteorian havainnosta rakennettiin uusi testikehys, joka myös perustui kohdeyrityksen vaatimuksiin. Kehyshupoteesia arvioitiin huoellisesti testauksen vaatimusten, ohjelmistokehyksien heuristiikkojen ja asiantuntija lausuntojen avulla.

Työn tuloksena on suositus testikehyksen työnkululle sekä käytännön toteutukselle. Kehys myös haastaa yleisen käsityksen siitä, että integraatiotestaus on pelkkä ohjelmistokehityksen välivaihe, ja tarkastelee testausta jatkuvana prosessina ja aina strategiselta tasolta päivittäiseen ja komponenttitasoon. Tutkimuksen tulos viimesitelee ehyen kertomuksen ja käsikirjan automatisoiden integraationtestauksen toetuttamiseen.
