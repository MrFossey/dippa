...
Since systems undergo continuous changes, improvements, upgrades, fixes, pilots, etc., the need for regression tests is common. Ideally, a prepared test set could be executed by invoking a simple command.
