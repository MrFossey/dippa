...
\tikzset{
  base/.style={draw, on chain, on grid, align=center, minimum height=4ex},
  proc/.style={base, rectangle, minimum height=4em, text width=7em},
  proclong/.style={base, rectangle, minimum height=4em, minimum width=6em, text width=7em},
  ellipse/.style={base, ellipse, minimum height=4em, text width=7em},
  line/.style={draw, thick, -latex'}
}

\begin{comment}
\node [proc] (datain) {Input data};
\node [proc, yshift=0.5cm] (datain0) {};
\node [proclong, right=of datain] (ins) {Instructions};

\node [ellipse, rihgt=of datain] (prc) {Test process};

\node [proc, right=of prc] (dataout) {Output data};
\node [proc, yshift=0.5cm] (dataout0) {};

\node [proc, right=of dataout] (exp) {Expected output data};
\node [proc, yshift=0.5cm] (exp0) {};

\node [ellipse, rihgt=of dataout] (com) {Comparison process};
