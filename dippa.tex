...
\begin{tikzpicture}[%
    ...
    node distance=6mm and 6mm, % Global setup of box spacing
...
\tikzset{
  ...
  test/.style={base, cylinder, aspect=2, text width=5em},
...
\path (p0.south) to node [near start, xshift=1em] {$y$} (p1); % added
