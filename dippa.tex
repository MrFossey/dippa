...
\citep{fewster1999software} present an integration testing automation process based on a test harness tool called Autotest. The straight-forward model in Figure \ref{fig:autotestprocess} shows a process extending from input and instructions to actual testing, then to output/expected output comparison and finally a test report.
