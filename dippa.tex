...
The current testing model at Wärtsilä is ad-hoc. There is no testing framework, only a collection tools which include: system for executing service requests to other systems, a bug tracker tool. Testing strategy and policy is described, but the practical approach is decided in projects.
