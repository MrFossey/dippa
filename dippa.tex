...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier and sets out to define a framework for integration testing, a practical\emph{modus operandi} for conducting tests.

The thesis expounds on integration testing theory and models, and extends the popular notion that integration testing is a mere transitional period in development. It leans on continuous integration, which appreciates testing through the integration life-cycle, and examines testing as process all the way from a strategic level to the mundane. 

Theoretical findings are crystallized in a framework for testing integration, which is also tailored for case company needs. The construct both describes testing process work flow and suggests technical implementation. The framweork is comprehensviely evaluated through requirements analysis, heuristic appraisal, and qualitative validation by company experts. 
