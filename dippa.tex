...
% What to test
Naturally, software has to be tested to after development , but there are other triggers, too. Any change in code or specifications, the environement, testing policy or plans can act a 
Prerequisite test passes, testing hierarchy
Code or sepcs change
Environment changes
Testin policy changes
Plan approved
Regerssion
Testing fix
