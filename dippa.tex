...
There are a total of six processes and three objects involved in the the proposed framework, along with the system under test (SUT) and a test resource database. The processes are divided into two steps. In the preparation step test resources are prepared and created, and in the execution step test resources are exercised in conducting integration tests.
