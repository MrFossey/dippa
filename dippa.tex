...
Wärtsilä requirements: support for protocols, a way to test asynchronous cases, performance testing, test case gerenration at least partly auomated (protocols a problem in soa)

a jumble systems plugged into the common esb, critical system
