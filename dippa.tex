...
The thesis does not delve into which metrics are best. Indicators should be evaluated according to Wärtsilä testing policy. The framework design must allow logging information about test runs, however.
