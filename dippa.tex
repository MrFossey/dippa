...
Verification is the step that gives test execution value. It transforms data from test runs to information with meanining. This is done through comparing the outputs with expected outputs. Colloquially, the step is often associated with test oracles, though \citep{fewster1999testing} argue for the term comparison since automated algorithms cannot tell about success of failure, but only apply rules to the test results.
