...
Figure \ref{fig:funnel} presents a testing framework on three levels of abstraction. Testing objectives and the general approach are defined in a testing plan or strategy. Typically, a plan includes test objectives, responsibilities and schedules, a list of necessary tools, process descriptions, and success criteria \citep{myers1976software}}}. Strategy is turned to a framework
