...
Each test is defined by the input data and instructions and the upper reaches of the process chain. The data should be complete enough for computational test execution. Comparisons are made with an array of different tools depending the file format.

The framework requires manual setup, for instance manualling validating and storing the expected outcome, but after some initial work, Fewster was able to eke out a 7 person week reduction compared to manual testing.
...
reductions of 10 person weeks to 3 person weeks.
