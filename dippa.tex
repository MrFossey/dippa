...
\newcommand{\SDATE}{Den 2 mars 2014}
...
Good testing is based on good plans, such as specifications of systems and models of their behaviour, and ensured by good governance. Though a virtue in its own right, technology has even made it possible for formatted plans to be translated into program logic directly, echoing the separation of structure and content, test logic and test data. However it remains a task for human discretion to decide what is to be tested and what the testing objectives are.
