...
\ref{fig: todo} presents the framework wireframe. Testing objectives and the general approach are defined in a testing plan or strategy. Typically, a plan includes ... (reference). Requirements are generally set by specifications of functionality or agreements on e.g. policy or service level. The teting process also requires an executable set of test cases, which should be constructed with regard to the stratey scope. 
