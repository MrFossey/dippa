...
% todo who will create test cases. which tool is easiest to use and most feasible. 
% todo present final list of requirements here?
...
The updated test framework contains an additional step for the new requirement of sending automated bug reports. The test database is now called a library as resources are not simply static values and the the term library is less prescribing in how test resources are stored and organized. %todo is this okay?
