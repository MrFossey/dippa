...
At the beginning of the meeting, participants were presented with a mission statement and a short introduction to the topic explaining the reasons that led to commissioning an automated testing framework study. Following this, the collected requirements (see Section \ref{section:requirements}) were shared with the intent to validate the requriements again and determine the most important ones. 

The first technical expert put most weight on the test generation requirement (R3). Concern centered on the labour cost of creating tests and generation was crucial in making larger scale testing economically feasible. While the generation requirment may be argued to be not the most important component of a testing framework, it clearly sparked excitement among the participants. It was the requirement that had most potential for gain. 

The testing expert was more concerned if the framework actually provided any actionable results. Therefore, the automated verification step (R6) was named the most important.
