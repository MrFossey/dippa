...
\begin{tikzpicture}[
    start chain=going below,    % General flow is top-to-bottom
    node distance=3mm and 25mm, % Global setup of box spacing
    ]
% ------------------------------------------------- 
\tikzset{
  base/.style={draw, on chain, on grid, align=center, minimum height=3ex},
  proc/.style={base, rectangle, minimum height=3em, text width=4em},
%  big/.style={base, rectangle, minimum height=8em, text width=10em},
   line/.style={draw, thick, -latex'}
}
% -------------------------------------------------
...
\node [proc, right=of thr] (int) {Interviews};
\node [proc, right=of syn] (exp) {Experiment};
