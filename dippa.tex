...
More focused areas like fault-based testing. The framework might supplemented by a set guidelines to include fault-based test cases, i.e. instructions for creating tests cases based on defects detected in the sytem.
