...
The framework is evaluated mainly by qualitative measures, but a quick heuristic analysis is also used to validate to new model. This done by comparisons to the idealized models, testing theory and recommendations from integration experts. , i.

ey characteristics of the automated regime test regime, system of government of testing \citep{fewster1999software}:
\begin{itemize}
