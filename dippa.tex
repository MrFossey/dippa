...
Reading through this thesis is like putting together Lego (hopefull as fun, too). In the background chapter the reader can peruse the contextual setting and instructions to assembly. In the next part, the reader is shown a ready model built by someone else for reference and inspiration. Next, the box is torn open and the reader can ponder over individual pieces and see how they they appear, feel, and stick. 
