...
-Scope: integraatioiden testaus webMethods-ympäristössä 
-Tuki testikeissien tekemiselle 
-Sanomien nauhoitus ja niiden toistaminen ja pukeminen testikeisseiksi 
...
\begin{tabular}{ l c }
  ...
  R1 & It shall be possible to scheudle automatical test runs. \\ \hline
  R1 & It shall be possible to write and generate test cases \\ \hline
  R2 & It shall be possible to capture and replay messages. \\ \hline
  R2 & It shall be possible to generate mock services or stubs. \\ \hline
  R3 & HTTP/XML, JDBC, (S)FTP messaging protocols shall be supported. \\ \hline
  \hline  
\end{tabular}
\end{center}
