...
\tikzset{
  ...
  test/.style={draw, dotted, -latex'}
    ...
    \draw[semithick] (-1,0) arc (180:0:2 and 0.5);                   % cone 2: top ellipse top arc
    ...
    \draw[semithick] (-1,0) arc (-180:0:2 and 0.5);                  % cone 2: top ellipse bottom arc
    \draw[semithick] (8,0) -- (6,-5);                               % cone 2: right side
    \draw[semithick] (-1,0) -- (4,-5);                               % cone 2: left side
    
    \draw[semithick] (3,0) arc (180:0:2 and 0.5);                   % cone 3: top ellipse top arc
    ...
    \draw[semithick] (3,0) arc (-180:0:2 and 0.5);                  % cone 3: top ellipse bottom arc
    \draw[semithick] (8,0) -- (6,-5);                               % cone 3: right side
    \draw[semithick] (3,0) -- (4,-5);                               % cone 3: left side
