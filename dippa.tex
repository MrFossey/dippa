...
The overall research problem is to devise a testing framework for automated integration tests. Here, framework refers to both the structure and configuraiton of the technical testing solution as well as process structure. Quality measures, which include functional and non-functional aspects, are described in more detail in chapter X. % TODO chapter num

A manual on the process of how to build a sword, not how to wield it.
