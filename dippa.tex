...
In \citeauthor{laukkanen2006data}'s \citeyearpar{laukkkanen2005data} model testing is divided into modules for test design, test execution, and test monitoring.
