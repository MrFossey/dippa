...
Lastly, the framework can be screened by looking at how it addresses the common integration pitfalls as presented in Section \ref{section:pitfalls}. Interpretation errors can be minimized by good design and specifications so that integration developers understand exactly what to develop. As such, the testing framework can only help indirectly, for instance by guiding test case creation.
