...
A workshop was organized to showcase the new framework model to interetested parties inside Wärtsilä. The purpose o of the event was to validate and improve; feedback both critical and supportive was elicited and statements on the applicabilit of the model in the target organization collected and suggestions to further improve the model was elicited communicate proposed new testing, 
