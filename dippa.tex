...
The testing expert was more concerned if the framework actually provided any actionable results. Therefore, the automated verification step (R6) was named the most important. If the framework cannot contribute to fixing defects in the integrations and making systems better, it would have little value. The discussion continued on the theme of reporting failures. An idea was of creating automated bug reports through integration with the bug tracker to was presented.
