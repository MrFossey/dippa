...
Software is abstracted and managed by splitting it to blocks. In fact, integration might be thought to be not between systems but between software components, which respects interfaces more broadly. One might ask if integration testing scope will become too bloated in this vein of thought. A computational trasaction with two points constituting an "integration". 
