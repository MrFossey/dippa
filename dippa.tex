...
This chapter examines indiviudal components and subprocesses of integration testing based on the funnel model derived in the previous chapter. First  after which the same is done to the more tangible framework/object level. 

% testing strategy
\section{Testing strategy}

Testing strategy is broken down to aspects of coverage/efficicency requirements, process, and results.
