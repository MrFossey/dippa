...
Key characteristics of the automated regime test regime, system of government of testing
\begin{itemize}
\item easy to select tests to be run at the touch of a button
\item those test take care of all their housekeeping such as environmental set-up and clear up
\item it is easier to add a new est to the automated pack than to run that test manually
\end{itemize}
