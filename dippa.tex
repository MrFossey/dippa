...
\citep{fewster1999software} present an integration testing automation process based on the tool Autotest. The simple process map shows process extending from input and instructions to actual testing, then to output/expected output comparison and finally a test report.
