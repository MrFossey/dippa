...
More focused areas like fault-based testing also merit research. The framework might supplemented by a set guidelines to include fault-based test cases, i.e. instructions for creating tests cases based on defects detected in the system.
