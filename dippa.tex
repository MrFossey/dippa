...
Reading through this thesis is like putting together Lego (hopefully nearly as fun, too). In the background chapter the reader can peruse the contextual setting and rough guidelines, not instructions per se, to assembly, while the in the next part, the reader is shown ready models, built by experts, for reference, example, and inspiration. After this, the box is torn open and the bricks scattered on the floor. The reader can ponder over individual pieces and see how they they appear, feel, and stick toghether   
