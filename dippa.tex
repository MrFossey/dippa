...
The framework was evaluated by mostly in-house experts whereas the testing effort may in fact be conducted by Wärtsilä's external suppliers and partners. Imposing practices to these stakeholders without consultation is surely unwise and subsequent framework implementation should be carried in co-operation with key stakeholders.

% todo
Although the framework construct met its requirements, it was not subjected to large scale testing.
