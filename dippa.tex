...
The researchers separated test case structure and logic for platform independence. The test logic and coniguration settings were encoded in separate XML files.
