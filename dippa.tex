...
This chapter reviewed the theoretical premises of integration testing and the practical context of the to-be framework at Wärtsilä. Integration testing can be done pairwise moving systematically over the entire system or through more system test oriented end-to-end tests where multiple integrations are tested in one test scenario. Previous research has proved that controlled early testing reduces development and maintetnance costs and is required throughout the software life-cycle. % Todo lähde 

Wärtsilä's relatively conformist technological and business environments should allow for and benefit from testing automation, which makes the thesis agenda highly relevant. 
