...
The testing expert was more concerned if the framework actually provided any actionable results. Therefore, the automated verification step (R6) was named the most important. The discussion continued on the theme reporting failures. of integration with a the bug tracking software and the possibility of creating automated  
