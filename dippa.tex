...
Verification is the step that applies value to test execution. It transforms data from test runs to information with meanining. It is the culmination point of testing.
...
% Verification is the final framework step where results from tests runs are 
...
% comparison ideal for automation
