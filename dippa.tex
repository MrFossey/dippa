...
\textbf{Test for most important functions.} Function importance may be attributed to e.g. message traffic, financial impact, etc.Tests that are easy to automate. Good for quick wins and return for investment. Also quickly ramps up the framework construction.
