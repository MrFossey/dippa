...
Well begun may be half done but the integration testing framework is not fully fledged and ready to be adopted for immediate use. At the very least it must be piloted in a project and streamlined to fit Wärtsilä's ways of working and any technical glitches ironed out. Perhaps more importantly, the benefits and costs related to other technical solutions, such as the one based on the monitoring solution, need to figured out, too, though the testing framework process is generic and can be implemented by different practical solutions. The construct was based on free and open source technologies but shifts in the tool landscape or taking into account the whole lifecycle of the tool technologies may incur unexpected costs. 
