...
Since there are cases where correct system behaviour cannot be verified by simply exmaining an output, service mocking is required. Consequently, a framework also needs a component for the creation of such mock-ups, prefereably using a strategy similar to test case creation. Actual records from production can be used as basis for a mock service that emulates
