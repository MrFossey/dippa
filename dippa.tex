...
Reasoning follows an abductive where an initial observation in the "real" world is brought under theoretical scrutiny and modeling. The subsequent ratinalisation is the then returned to inductive empirical appraisal and generalized back to theory and a new refined model.
