...
\tikzset{
  ...
  line/.style={draw, thick, -latex'},
    ...
    \node [rect, right=of s2.1] (s3.1) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s3.2) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s3.3) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white, label=below:{System 3}] (s3.4) {Service};
    
    \node [rect, right=of s3.1] (s4.1) {};
