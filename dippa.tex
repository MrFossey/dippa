...
\tikzset{
  ...
  test/.style={draw, dotted, -latex'}
    ...
    \draw[dashed,color=gray] (-4.5,-5) arc (180:0:0.5 and 0.25);        % cone 1: bottom ellipse top arc
    \draw[semithick] (-4.5,-5) arc (-180:0:0.5 and 0.25);               % cone 1: bottom ellipse bottom arc
