...
\begin{tikzpicture}[
    start chain=going below,    % General flow is top-to-bottom
    node distance=7mm and 50mm, % Global setup of box spacing
    ]
% ------------------------------------------------- 
\tikzset{
  base/.style={draw, on chain, on grid, align=center, minimum height=4ex},
  ...
  box/.style={draw, minimum height=3em, fill=lightgray, rectangle},
  line/.style={draw, thick, -latex'}
}
% -------------------------------------------------
% Placing the nodes
...
\begin{pgfonlayer}{background}
  \node[box] [fit = (p2) (p5)] {Execution engine};
\end{pgfonlayer}

\begin{pgfonlayer}{background}
  \node[box] [fit = (p1)] {Surrogate engine};
\end{pgfonlayer}
