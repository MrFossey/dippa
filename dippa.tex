...
When tests compare as much information as possible, they are called sensitive tests. Conversely, more selective comparisons constitute robust tests. Both of test can be useful in different stages of testing. \citep{fewster1999software} argue that sensitive tests are good when and robust ones when moving to more .
