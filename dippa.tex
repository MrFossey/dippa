...
\small
\begin{itemize}
\item 1. Find a practically relevant problem which also has research potential.
\item 2. Obtain a general and comprehensive understanding of the topic.
\item 3. Innovate, i.e., construct a solution idea.
\item 4. Demonstrate that the solution works.
\item 5. Show the theoretical connections and the research contribution of the solution concept.
\item 6. Examine the scope of applicability of the solution.
\end{itemize}
\normal
\end{adjustwidth}
