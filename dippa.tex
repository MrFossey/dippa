...
As cases are run the execution traces or results are collected by . The traces are compared and verified with expected results determined by the test case and, if needed, compared the execution engine records. 
...
\end{tikzpicture}
\caption{Testing framework, adapted from \citet{liu2009unified}} \label{fig:UTF}
\end{figure}
% =================================================
