...
\item Add the correct endpoint URL in the request edit window, e.g. for the example service: \url{<http://wesbqa.wartsila.com:5557/ws/sco.common.ws:SCOServiceProvider>}.
