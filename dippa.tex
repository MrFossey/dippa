...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier's integration platform and sets out to define a framework for integration testing, a practical\emph{modus operandi} for conducting tests .
