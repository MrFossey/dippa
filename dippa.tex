...
\tikzset{
  ...
  bus/.style={base, rectangle, minimum width=35em, text width=8em},
  line/.style={draw, thick, -latex'},
    ...
    \node [rect, xshift=-4.00cm] (s2.1) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s2.2) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s2.3) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white, label=below:{System 2}] (s2.4) {Service};
    
    \node [rect, right=of s2.1] (s3.1) {Service 3};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s3.1) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s3.2) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white, label=below:{System 3}] (s3.3) {Service};
    
    \node [rect, right=of s3.1] (s4.1) {Service 4};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s4.2) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s4.3) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white, label=below:{System 4}] (s4.4) {Service};
...
\end{tikzpicture}
\caption{SOA architecture} \label{fig:soa}
\end{figure}
...
\tikzset{
  ...
  test/.style={draw, dotted, -latex'}
    ...
    \node [rect, right=of prc] (exe) {Testing execution};
