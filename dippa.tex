...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \draw[dashed,color=gray] (-1,-5) arc (180:0:1 and 0.25);        % cone 1: bottom ellipse top arc
    \draw[semithick] (-1,-5) arc (-180:0:1 and 0.25);               % cone 1: bottom ellipse bottom arc
    \draw[semithick] (-5,0) arc (-180:0:3 and 0.5);                 % cone 1: top ellipse bottom arc
    \draw[semithick] (-2,0) -- (-1,-5);                               % cone 1: right side
