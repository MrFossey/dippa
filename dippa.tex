...
The oft-cited reasons for testing automation are improving software quality and cost-efficiency: harnessing the power of computers helps expedite the testing process as well as reduce the amount of manual work. \citep{laukkanen2006data} give a more complete list of automation benefits: 
...
Test cases are constructed manually as is the collection of requirements, and the testing process itself. Testing is done when needed, usually after some change or update has been implemented in one or more of Wärtsilä's or Wärsilä's partners' systems. Test cases and results are collected in documents, but no material is explicitly made reusable. Results are used for decision-makin\ldots 
