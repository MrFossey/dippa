...
Integration testing can fail in many ways. Testing may be overlooked as a non-value adding activity and integration considered done as soon as systems have been connected. Alternatively, testing resources are considered expendable, testing a low priority, and testing becomes the projects 'crushable zone'. Not identifying and communicating integration strategy, resposibilites and accountabilities -- or sharing knowledge -- are also typical pitfalls, according to Moll and Ammerlaan. Additional problems are caused by physically separated locations, failing configuration or incident management. 
