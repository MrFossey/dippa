...
Automation is one of the great boons brought on by technological development on one hand freeing up resources like labour for more value-adding purposes --- and permitting the execution of uniform, repeatable processes and control on the other. The pinnacle of advancement and prosperity on which society stands today is based on a continuous flow of various tasks and services, many of which are complex and involve a slew of actors or agents. Work is divided and its completion therefore requires cooperation, which poses another challenge.

% integration reasons and logic
Integrating disparate actors and information systems is a prerequisite of automation. The principles and drivers of  a distributed system are not unlike those behind the divison of labour. Complex tasks are easier to solve when divided and each part administered by a dedicated expert. Distributed systems also enable incremental growth, which, of course, is sometimes a less consciously pursued natural evolution and accretion of new information services. Other benefits of an interdependent and connected information technology system include reduction in the number of systems related upkeep, maintenance, and development costs, which also reduces the degree of complexity in the set-up. 
% economies of scale, communication, sharing resources, 
% The negatives in integrated systems.  
Integration efforts may, however, result in unclear responsibilities and difficulties in determining if the systems cooperate and behave correctly, and if any usecases are unaccounted for. In a distributed system there are more components and connections that can fail and relinquishing control over systems and services always carries risk. A high number of integrations makes the task even more difficult since a single change in the system components can disrupt the a whole chain of operation.

% business motivation and technical considerations 
The benefits outweighing all shortcomings, modern coprorations' business processes rely on automation and operate on distributed systems and networked devices. But the problems are still there; ensuring quality of service is essential. Systematic, rigorous, and automated testing, both functional and non-functional, is required. This thesis examines the requirements of system-to-system integration testing in a real business setting.

\section{Research question}

The overall research problem is to devise a testing framework for automated integration tests. Here, framework refers to both the testing solution technology and librarys. Quality measures include functional and non-functional aspects and are described in more detail in chapter X.

The research problem can be divided into three questions:

% 1. Determine requirements.
1. What are the requirements for a testing framework in the context of x integration set-up? The requirements are based on x IT operation environment. This includes canonical examples of integrations, for instance between the ERP system and warehouse systems, and the ERP system and the PDM system.
 % 2. Compare alternatives, choose best one.
2. Which is the best integration testing framework in of the requirements among a limited set of alternatives? First, promising framework alternatives are listed after which, based on the requirements, a shortlist is composed. These frameworks are more carefully evaluated in light of the requirements, features, and public opinion. One or two alternatives are selected for the next step.
 % 3. Test viability. Proof of concept.
3. How can the selected framework be implemented? Answering the third research question involves proofing the selected frameworks. This is a sanity test of the suitabiltiy of the chosen framework, but the actual implementation of the test framework and adopting is not part of the thesis.

Finally, guidelines and recommendations observed in the third part are collected and presented (see attachment 1).

% why is the problem interesting in THIS case?
The automated testing setup helps uncover defects and issues eariler and resolve them with fewer resources.

% TODO: consult professor, instructor about research method
\section{Research methods}
Research is conducted accordding to the constructive research method paradigm --- a six step model, where a concrete problem is investigated through practical experience and academic understanding, and the conclusions and concept tested in a working simulation. The emphasis is not produce hard fact to the academic canon, but to produce hypotheses and theories and then test them in practice.
% TODO: insert citation and chart depecting research method

As a scientific work and to satisfy te first two steps, the thesis's research problem must be relevant and robust enough for academic research. The third crucial step contains a novel solution and new understanding, which is then argued in step four. In the fifth step the resaercher compares the built solution to theory and in the final step evaluates its applicability in light of the original research problem.
...
This master's thesis study is divided to number_of_parts parts. First, a definition of testing frameworks, their workflows, and purpose are provided. Second, the approaches for testing automation are examined. Thirdly, the overall of the testing setup is evaluted from the perspective of defect management. 

The empiric part of the study appraises a limited set of testing frameworks and how well they meet the needs of a real business case. It then identifies one as superior, presents a proof-of-concept implementation of it, and finally offers guidelines and recommendations for full implementation and adoption of the testing framework. 

The last chapter contains reflection on both the theoretical and empirical part of the study and if the work met its objectives.
