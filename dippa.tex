...
The framework was evaluated by mostly inhouse experts whereas the testing effort may in fact be conducted by Wärsilä's external suppliers and partners. Imposing practices to these stakeholders without any consultation is surely unwise. The framework implementation should be carried in strict co-opreation with key stakeholders.
