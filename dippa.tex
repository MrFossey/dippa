...
Verification is the step that gives test execution value. It transforms data from test runs to information with meanining. Colloquially, this step is often called
