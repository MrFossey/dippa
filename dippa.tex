...
\node [proc, right=of prc, yshift=1.00cm] (dataout0) {};
\node [proc, right=of prc, yshift=1.80cm, xshift=0.20cm, fill=white] (dataout) {Output data};

%\node [proc] (exp0) {};
\node [proc, fill=white] (exp) {Expected output data};
