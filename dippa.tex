...
The overall research problem is to devise a testing framework for automated integration tests. Here, framework refers to both the testing solution technology and librarys, and the applied methods required to assure quality. Quality measures include functional and non-functional aspects and are described in more detail in chapter X.
