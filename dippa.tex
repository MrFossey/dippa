...
When cases or mock services are ready they are tested and verified before being saved as test resources in the appropriate files or packages. This concludes the pre-test setup work. The actual testing begins when scheduled test runs pick up cases or invoke mock services and 
