...
% todo: indeed a steretypuical proces, defeinition

Since all of the models are rather pragmatic and technical a more holistic perspective is reserved for further analysis on the nature of the integration testing framework. Figure \ref{fig:funnel} presents a framework on three levels of abstraction (horizontal dimension) and on the process dimension (vertical) just discussed. 

The vertical dimension, presented as a tapering funnels, depict the process dimension. Each framework abstraction takes some input which it refines into an outcome or deliverable.
%Pace of integration, rate of automation, definition for I/O process

The framework is analyzed from a strategic, tecnical/structural, and component level. Starting from the left, general testing strategy and requirements are accepted as premises and translated into a framework structure, largely uniform, but flexible enough to conform to minor project idiosyncrasies. 

The structure should be robust or modular enough to be separable into clear and concrete constituent parts, like test cases. The modularity permits the fluent addition of new test cases, integrations, or other components to the framework.
