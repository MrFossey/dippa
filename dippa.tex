...
ESB & \textbf{E}nterprise \textbf{S}ervice \textbf{B}us. An integration architecture and collection of middleware technologies enabling such. \citep{} \\[0.3cm] % todo

Failure & The state or condition of failing to meet expectations or objectives. \\[0.3cm] % todo 

Fault & An abnormal condition or defect at the component, equipment, or sub-system level which may lead to a \emph{failure}. ISO/CD 10303-226 \\[0.3cm] % todo
...
Functional testing & Testing functional qualities of software. \\[0.3cm] % todo
