...
On the final level are physical objects which realize the testing process: the tested cases, a test executing instance, and testing results in human or machine readable form. These should be constructed with regard to the chosen stratey and framework scope. 

% add suitable process definition
The vertical dimension, presented as a tapering funnels, depict the process dimension. Each framework abstracton takes some input which it refines into an outcome or deliverable.
