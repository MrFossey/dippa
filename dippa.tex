...
Well begun may be half done but not ready. The integration testing framework is not fully fledged to be adopted immediately for use and must be further evaluated in a pilot project.  

% evaluatint other options
% must be piloted first
% cannot recommend to implement construction
