...
\begin{tabular}{ l p{12cm} }
  ...
  R2 & It shall be possible to schedule automatic test runs. \\ \hline
  ...
  R6 & It shall be possible to validate test results automatically. \\ \hline
  R7 & HTTP/XML, JDBC, and (S)FTP messaging protocols shall be supported. \\ \hline
  R8 & It shall be possible to generate test loads, and conduct load tests. \\ \hline
