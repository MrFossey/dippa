...
\begin{tikzpicture}
    ...
    \draw[semithick] (-4,0) -- (-1,-7);
    \draw[dashed,color=gray] (-1,-7) arc (180:0:1 and 0.25);% right half of the left ellipse
    \draw[semithick] (-1,-7) arc (-180:0:1 and 0.25);% left half of the left ellipse
    
    \begin{comment}
    \draw[dashed,color=gray] (-1,0) arc (-180:0:2.5 and 2.5);% right half of the left ellipse
	\draw[semithick] (0,0) -- (1,4);% bottom line
	\draw[semithick] (0,3) -- (2,4);% top line
	\draw[semithick] (0,0) arc (270:90:0.5 and 1.5);% left half of the left ellipse
