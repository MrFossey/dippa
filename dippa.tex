...
\item Task coverage (each task performed at least once)
\item Simple Temporal Relationship Coverage
\item Complete Temporal Relationship Coverage
\item n-Task combination coverage
\item Interruption coverage (interruption of task by ther task)
\item Random selection
\item n-m-Concurrency-Coverage
\item Path coverage
