...
Two technical experts, a testing expert, and three members of a partner's infrastructure team attended the workshop. The partner members and one of the technical experts joined the meeting via remote access. The meeting agenda and purpose was explained to all participants beforehand. Of particular interest were the observations of people who're actually to use the framework if should it be adopted. And how do they see creating test cases, managing test results, or otherwise maintaining the framework.
