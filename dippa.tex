...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \draw[semithick] (-5,0) arc (180:0:5 and 0.5);                  % cone 1: top ellipse top arc
    ...
    \draw[semithick] (-5,0) arc (-180:0:5 and 0.5);                 % cone 1: top ellipse bottom arc
    \draw[semithick] (5,0) -- (1,-5);                               % cone 1: right side
    \draw[semithick] (-5,0) -- (-1,-5);                             % cone 1: left side
