...
Wärtsilä's business relies on over X different systems, which are crosscut by information processes. The process chains, then, depend on many different systems. The architeture is built on the service-orientation principle (SOA) where individual components lend themselves to be called on by other services through a common.
