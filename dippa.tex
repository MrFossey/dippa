...
The results of test effectiveness can be measured by how many cases were exected out of the set of necessary cases and testability by how many test cases are necessary for satisfyig a criterion (Linnenkugel & Müllerburg 1990). Attention must be spent on both selecting the method of execution and test criteria. 
...
The graph can serve as a foundation for setting test coverage criteria and strategy or test case creation (Benz 2008; Hura & Dimmich 2011; Linnenkugel & Müllerburg 1990). Using model-driven integration Wieczorek et al. (2010) estimated savings of 50\% in time for test generation and concretization tasks.
...
simulating unavailalbe systems, and . Both frameworks are grounded on models or descriptions of the systems helping to automate stub or test case creation. Integration testing is done on a continuous basis (CIT, continuous integration testing) right from the start of development.

INSERT FIGURE HERE
% Thin threads, groupin into a tree (tsai et al)
% Test data difficult to select (linnenkugel mullburg)

This type of framework combines a solid foundation understanding the integration set-up,  and automatically producing test cases.
