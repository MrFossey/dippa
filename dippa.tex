...
For clarification, it should be noted that Jenkins is made with software development rather than regression testing in mind. At the minimum, Jenkins is given a test case execution script courtesy of SoapUI which it runs in the native opering system's environment and collects traces provided by the cases and script. 
