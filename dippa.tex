...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier and sets out to define a practical\emph{modus operandi} for conducting tests. Theoretical findings are crystallized in an integration testing framework, which is also tailored for case company needs. The framework is comprehensviely evaluated through requirements analysis, heuristic appraisal, and qualitative validation by company experts. 

The thesis expounds on integration testing theory and models. Previous frameworks are deconstructed and carefully analyzed and their best features combined in the framework construct. and extends the popular notion that integration testing is a mere transitional period in development and instead leans on continuous integration, which appreciates testing through the integration life-cycle, and examines testing as process all the way from a strategic level to the mundane. 

The construct both describes testing process work flow and suggests technical implementation. 




The study suggests two general ways of conducting tests and suggests
