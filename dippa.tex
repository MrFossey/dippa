...
all-loop-iteratzon-free-call-sequencerse quires that every sequence of (descending) calls without repetition of loops is executed at least once, i.e. that every loop-iteration free path of the p-graph is covered (all-loop-iterationfree-paths).
