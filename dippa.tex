...
Along with the functionality of the system, tests should also be applied on non-functional measures such as performance and usability, because these also determine the .
...
\section{Regression in integration testing}
% models and unified framework
...
Test case creation is perhaps the most time-consuming task in automated testing. 
Tsai et al. (2001) also presented an XML-based framework for automtaed test case generation 

from WSDL service descriptions.
