...
The Wärtsilä framework is designed so that it can be supplemetned with new test cases. Tests can divided into groups so that only the tests that need to be exectuted are. Tests can be scheuled to run regularly.
