...
The issue of framework maintanence was raised by the testing expert. Because the proposed model would require test included test cases created through capture, test resources would have to be updated. After discussing the matter with the technical experts it was concluded that test reusability would be high because test cases would have to change very infrequently. Hence, capture was accepted as a cost-effective way to create test resources.
