...
integration and determining which connections are there to test. Hewett and Kijsanayothin (2009) persuade testers to lay out andquantify components and their connections in a graph and use this information to design the 
most efficient order for testing, with a minimal need for creating test stubs. Likewise, Lueng and White (1990) and Abdullah et al. (1995) endorse the concept of a firewall, which draws a line between 
