...
Finally, it is worth noting that the thesis does not make any explicit recommendations as to which aspects of automted testing should be measured and used as key indicators. The metrics are context specific and may include anytrhing from number of test cases, passed tests, failures, bytes taken, coverage, etc.
