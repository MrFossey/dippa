...
Were presented with a mission statement and introduction to the topic. The collected requirements were also presented and the most important requiremetns elicited. Most weight on the test generation. Concern of the labor cost this would involve. while it may be argued not to be the most important component of a testing framework, it showed the motiovation for the work. conversely the testing expert was more concerned with if the framework actually provided any actionable results. the automated verification step named the most important. technical expert agreed,  while the implementers underlined the importance of performance tests.
