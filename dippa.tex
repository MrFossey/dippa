...
Of particular were the observations of people who were actually to use the framework if it were adopted. and how they saw how did the users of the model see it and their work in maintainen the model, creating new test cases etc.
