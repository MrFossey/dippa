...
1. What are the requirements for a testing framework in the context of Wärtsilä's integration set-up?
...
2. Which is the best integration testing framework in of the requirements among a limited set of alternatives? 
...
% 3. Choose best one.
3. How can the selected framework be implemented?
