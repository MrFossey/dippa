...
% todo: indeed a steretypuical proces, defeinition The process funnels can be favourably compared to e.g. \citeauthor{davenport1993process}'s \citeparyear{davenport1992process} definition of a business process or a software method that takes some parameters and return some output.
