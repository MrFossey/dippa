...
1. What are the requirements for an automated integration testing framework?
...
The first part then proceeds to requirements analysis and uncovering the criteria for a suitable framework structure. These requirements are based on Wärtsilä's operational IT environment as well as generic observations made earlier in the study. Wärtislä's system environment is a canonical example of corporate IT and electronic business processes and integrations, consisting for instance between the ERP system and warehouse systems, and the ERP system and the PDM system which should lend itself well to comparisons to previous research.\\

I    Minkälaisia vaatimuksia integraatiotestausprosessilla on?
	
Testauksen järjestäminen
- Mitä on integraatiotestaus/Miten integraatiotestata fiksusti?
- Mistä prosesseista integraatiotestaus koostuu?
- Mitä Wärtsilä tarvii testaukselta?
