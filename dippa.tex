...
One of the key findings is that CI actually helps bridge the gaps in integration testing theory when examining the entire software lifecycle. Authors like Myers and XX and textbooks () still continue to present integration testing as a software component assembly task and a mere staging post in sofware development. CI connects integration testing with regression testing and while respecting t 
