...
\tikzset{
  ...
  proclong/.style={base, rectangle, minimum height=4em, minimum width=4em, text width=4em},
  elli/.style={base, ellipse, minimum height=4em, text width=4em},
  line/.style={draw, thick, -latex'}
}
...
\node [elli, rihgt=of datain] (prc) {Test process};
...
\node [elli, right=of dataout] (com) {Comparison process};
