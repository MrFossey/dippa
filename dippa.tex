...
Comparison differs in complexity. Simple comparison looks for an identical eatch between ouutput and expected output. The apparoch is effective but inflexible. Complex comparison takes into account known variance in test results. Testers also need to define the granularity of test scripts, or how dep 
