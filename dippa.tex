...
At the heart of the framework lies the test execution system which houses test libraries, driver scripts and the test data parsers, as well as the logger and report generator utilities.
