...
The framework includes a visualization layer and GUI, an execution engine which also collects execution traces. The engine is an IDE or integrated development environment which is also used in test case construction. The suite is capable of test script capture and playback.

Scheduling test runs is done with 
