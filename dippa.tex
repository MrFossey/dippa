...
Finally, it should be remarked that the models do not address performance testing directly. Perhaps this is implicit in the tests as 
...
% todo add something about absenece of performance testing, add it to model review, final conclusions and general testing
