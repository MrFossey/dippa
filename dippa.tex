...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier and sets out to define a practical\emph{modus operandi} for conducting tests, an integration testing framework.

The thesis expounds on integration testing theory and models. Existing frameworks were deconstructed and carefully analyzed and their best features collected. These practical insights were then combined with theoretical findings and crystallized into an integration testing framework, which was also tailored for case company needs. The framework was then comprehensviely evaluated through requirements analysis, heuristic appraisal, and qualitative validation by company experts. 

The framework construct successfully both describes testing process work flow and suggests technical implementation It extends the popular notion that integration testing is a mere transitional period in development and examines testing as process all the way from a strategic level to the mundane. 
