...
IBM uses proprietary tool based on agents to collect traces, not applicable here where the return message is simply used as trace paired with execution records from jenkins
