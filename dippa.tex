...
SOA & Service-oriented architecture. A software architecutre principle where \\
UTF & Unified testing framework \\
WSDL & Web service description language, an XML-based defnition of a web service interface \\
