...
XML & \textbf{E}xtensible \textbf{M}arkup \textbf{L}anguage.  \\[0.3cm]
...
Accordingly, what can only be called a gross initial oversight, visualizing the test results is added as a process to the overall framework process.
