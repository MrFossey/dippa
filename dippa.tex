...
This chapter presents a construct built to address Wärtsilä's testing needs, based on theoretical observations made earlier in the study and guided by previous works and examples. The purpose of the construct is to act as proof of concept and, in true testing form, give early indicators of how sound and valid the theoretical foundations are and highlight practical concerns that arise during the experiment.
