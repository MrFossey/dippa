...
Whenever changes are made to a feature in software, test cases should also be updated accordingly. Uniform structure, centralized storage, and metainformation can already facilitate this. Of course left unattended, the deprecated cases may well fail prompting the update task. But they might also 
