...
Wärtsilä's business releis on over X different systems, which are crosscut by information processes. The process chains, then, depend on many different systems. 
