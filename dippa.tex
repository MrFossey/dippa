...
The thesis expounds on integration testing theory and models, and extends the popular notion that integration testing is a mere transitional period in development. It leans on continuous integration for  

A framework for testing integration is constructed which combines both process work flow and suggests technical implementation. The construct is validated through comprehensive evaluation, based on requirements, heuristic appraisal and qualitative evaluation by company experts.

Integration testing is a stalwart 

The thesis adopts a broad view extending integration testing outside of a mere transitional period
