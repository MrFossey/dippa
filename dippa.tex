...
\tikzset{
  ...
  test/.style={draw, dotted, -latex'}
    ...
    \node [rect, right=of fmw] (art) {Artefacts};
    \node [rect, right=of tcg] (tcs) {Test cases};
    \node [rect, right=of run] (exe) {Execution engine};
    \node [rect, right=of mon] (out) {Testing outcomes};
    ...
    \draw[semithick] (2,0) arc (180:0:2 and 0.5);                   % cone 2: top ellipse top arc
    ...
    \draw[semithick] (2,0) arc (-180:0:2 and 0.5);                  % cone 2: top ellipse bottom arc
    \draw[semithick] (8,0) -- (6,-5);                               % cone 2: right side
    \draw[semithick] (2,0) -- (4,-5);                               % cone 2: left side
    
    \draw[semithick] (9,0) arc (180:0:2 and 0.5);                   % cone 3: top ellipse top arc
    ...
    \draw[semithick] (9,0) arc (-180:0:2 and 0.5);                  % cone 3: top ellipse bottom arc
    \draw[semithick] (8,0) -- (6,-5);                               % cone 3: right side
    \draw[semithick] (9,0) -- (4,-5);                               % cone 3: left side
