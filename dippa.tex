...
In the construct managing the test packages and executing the tests are removed from the development environment for two reasons. Firstly, testing and test case development is separated. Those who only wish to examine the health of the systems can do so through the CI controller with a graphical UI. Restricting access to code is also a security measure.
