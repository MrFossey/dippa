...
% chapter about benefits of automation, build-up to integration
...
% chapter about integration reasons and logic
Integrating disparate actors and information systems is a prerequisite of automation. Distributed system principles are not unlike those behind the divison of labour and the case can be arg  The reasons for having a distributed system with integrated components is justified through the same principles as division of labour, though sometimes it is more a result of naturally produced accretion, expansion or evolution in the constituent systems. Benefits of an interdependent and connected information technology system include having closed and manageable environments and a reduction in the number of systems and related upkeep, maintenance, and development costs, which also reduces the degree of complexity in the set-up. 
% economies of scale, communication, sharing resources, solving complex tasks, incremental extension
% more components to fail, relinquishing control, security

However, integration efforts may result in unclear responsibilities and difficulties in determining if the systems cooperate and behave correctly, and if any usecases are unaccounted for. In a distributed system there are more components that can fail and relinquishing control over systems and services always carries risk. A high number of integrations makes the task even more difficult since a single change in the system components can disrupt the whole operation. 

Systematic, rigorous, and automated testing is required. 

% business motivation and technical considerations 
Business processes in modern corporations rely on automation and operate on distributed systems and networked devices. Ensuring quality of service is essential and ensuring the delivery critical; service processes must be tested and their performance ascertained. This thesis examines the requirements of system-to-system integration testing in a real business setting.

\section{Research question}

% research problem. what is a framwork? what is integration testing?
The research objevtive is . Here, framework is a collection of testing solutions required to assure integration quality. Quality is measured and compared to set targets and requirements, the definition of which is also part of the thesis work.
