...
Cost should be compared to benefits from test automation and any alternative tools. It should also be estimated how easy it is to switch from one tool engine to another, should the need arise, in order to properly address risks, like vendor lock-in. This is also why test resources should be stored in a standard rather than proprietary format.
