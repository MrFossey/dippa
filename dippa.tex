...
The benefits outweighing the shortcomings, modern coprorations' business processes rely on automation and operate on distributed systems and networked devices. Ensuring quality of service is essential: systematic, rigorous, and automated testing is required. Service processes must execute correctly and meet set performance goals. This thesis examines the requirements of system-to-system integration testing in a real business setting.
