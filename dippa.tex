...
\path (f0.south) to node [near start, xshift=1em] {$y$} (p0);
  \draw [*->,lcnorm] (f0.south) -- (p0);
\path (p0.south) to node [near start, xshift=1em] {$y$} (f1);
  \draw [*->,lcnorm] (p0.south) -- (f1); 
\path (f1.south) to node [near start, xshift=1em] {$y$} (p1);
  \draw [*->,lcnorm] (f1.south) -- (p1);
\path (f1.east) to node [near start, xshift=1em] {$y$} (p1);
  \draw [*->,lcnorm] (f1.east) -- (p1); 
\path (p1.south) to node [near start, xshift=1em] {$y$} (e0);
  \draw [*->,lcnorm] (p1.south) -- (e0); 
\path (e0.south) to node [near start, xshift=1em] {$y$} (s1);
  \draw [*->,lcnorm] (e0.south) -- (s1); 
\path (s1.south) to node [near start, xshift=1em] {$y$} (e1);
  \draw [*->,lcnorm] (s1.south) -- (e1);
\path (s1.south) to node [near start, xshift=1em] {$y$} (p2);
  \draw [*->,lcnorm] (s1.south) -- (p2); 
\path (p2.south) to node [near start, xshift=1em] {$y$} (f2);
  \draw [*->,lcnorm] (p2.south) -- (f2); 
\path (f2.south) to node [near start, xshift=1em] {$y$} (p1);
  \draw [*->,lcnorm] (f2.south) -- (p1);
