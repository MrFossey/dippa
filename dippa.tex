...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier and sets out to define a practical\emph{modus operandi} for conducting tests, an integration testing framwork.

The thesis expounds on integration testing theory and models. Existing frameworks were deconstructed and carefully analyzed and their best features combined in a new framework construct. The framework was then comprehensviely evaluated through requirements analysis, heuristic appraisal, and qualitative validation by company experts. 


Theoretical findings are crystallized in an integration testing framework, which is also tailored for case company needs. 

The construct both describes testing process work flow and suggests technical implementation and extends the popular notion that integration testing is a mere transitional period in development and examines testing as process all the way from a strategic level to the mundane. 
