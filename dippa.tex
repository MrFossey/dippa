...
Wärtsilä requirements: support for protocols, a way to test asynchronous cases, performance testing, test case generation at least partly auomated (protocols a problem in soa), stubbing systems
