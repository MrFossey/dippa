...
\citep{fewster1999software} present an integration testing automation process based on a test harness tool called Autotest. The straightforward model in Figure \ref{fig:autotestprocess} shows a process extending from input and instructions to actual testing, then to output and expected output comparison and culminates in a test report.
