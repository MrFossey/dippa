...
In particular researchers advocate the creation of a call graph (lueng white, Hulburt, linnenkugel), which explicitly maps intearactions and relationships between integrated system components. The call graph can be used as a tool to communicate integration structures and schemes, and to organize testing. A systematic sweep of components and component connections is used to uncover any defects in the integration phase. 
