...
The distinction between unit, integration, and system tests is not always clear. Some authors consider end-to-end integration tets system tests, ohters introduce component testing to 
