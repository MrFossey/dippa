...
The framework was evaluated by mostly in-house experts whereas the testing effort may in fact be conducted by Wärtsilä's external suppliers and partners. Imposing practices to these stakeholders without any consultation is surely unwise. The framework implementation should be carried in co-operation with key stakeholders.
