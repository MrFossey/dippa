...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \draw[dashed,color=gray] (-3,-5) arc (180:0:1 and 0.25);        % cone 2: bottom ellipse top arc
    \draw[semithick] (-3,-5) arc (-180:0:1 and 0.25);               % cone 2: bottom ellipse bottom arc
    \draw[semithick] (2,0) arc (-180:0:3 and 0.5);                  % cone 2: top ellipse bottom arc
    \draw[semithick] (2,0) -- (-1,-5);                              % cone 2: right side
    \draw[semithick] (-5,0) -- (-3,-5);                             % cone 2: left side
