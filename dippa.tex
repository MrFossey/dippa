...
Continous testing (CI) is a further approach where testing is done frequently as changes are made to source code. The purpose is to weed out issues and defects before they take root can cause major trouble. \citet{duvall2006continuous} described continuous integration as:
