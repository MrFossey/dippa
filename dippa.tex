...
Three technical experts at Wärtsilä shared their views on the framework requirements in interviews conducted by the researcher. The experts at enterprise architecutre, integrations, and testing system-to-system connections. 

The interviews, approximately an hour in length, were loosely structured and had no presumptions about the nature of the framework-to-be. The mission was to elicit requirements for integration testing including technical and functional and practical aspects. The two latter interviewees were presented findings from earlier interviews for validation and the addition of any comments.
