...
The most sought-after results were the observations of people who're actually to use the framework if should it be adopted, and how do they saw creating test cases, managing test results, or otherwise maintaining the framework.
