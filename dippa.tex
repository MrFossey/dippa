...
, a delay in testing is not ideal for a large and complex integration undertaking. Examining the integration as a whole and pinpointing defects is difficult in the tumult of the big-bang \citep{myers1976software, \citet{pezze2008software}. A better option would be to test early and little by little. For new systems in development, this integration-by-integration testing requires drivers and stubs as stand-ins to make up for the absence of actual components or modules needed for tests. 
