...
Deriving test cases from models or using models to represent the testing strategy is known as model-based testing. It uses specifications or program code to derive the model \citep{pezze2008software}.
