...
\tikzset{
  ...
  sut/.style={base, circle, text width=5em},
  ...
  eng/.style={draw, trapezium, trapezium left angle=70, trapezium right angle=-70, minimum height=1cm}, 
