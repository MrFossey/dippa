...
A workshop was organized to showcase the new framework model to interetested parties inside Wärtsilä and to evaluate its applicability in the company. The purpose of the event was twofold: to validate and improve. Feedback both critical and supportive was elicited and suggestions for further improvement collected. The workshop event was facilitated by the author.

Of particular was the, how did the users of the model see it and their work in maintainen the model, creating new test cases etc.
