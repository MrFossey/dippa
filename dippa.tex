...
Execution traces are simply full text accounts of test results. These include information on the test case level or which case failed, which is why tests should only have one assertion if possible \citep{duvall2007continuous} as this helps seeing what is wrong the program and where the defect might be.
