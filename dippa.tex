...
\node [file] (rec) {Mes-sage record};
\node [proc] (gen) {Integration test case generation};
\node [file] (cse) {Test case};
\node [syst] (exe) {Test case execution};
\node [proc] (upd) {Updating test package};
% add step: add file to test package
\node [sut] (sut) {System under test};
\node [syst] (eng) {Surrogate engine};
\node [proc, right=of cse] (ver) {Verification};
\node [file, right=of exe] (trc) {Exe-cution trace};
\node [proc, right=of sut] (col) {Trace collecting};
\node [proc, right=of eng] (sgt) {Surrogate execution};

\path [line] (cap) -- (rec);
\path [line] (rec) -- (gen);
\path [line] (gen) -- (cse);
\path [line] (cse) -- (ver);
\path [line] (ver) -- (exe); % Todo: what is this?
\path [line] (cse) -- (exe);
\path [line] (exe) -- (sut);
\path [line] (sut) -- (eng); 
\path [line] (sgt) -- (eng);
