...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \node [rect, xshift=-2.0cm, yshift=0.25cm] (req) {Requirements \& input};
    ...
    \draw[semithick] (-3,0) arc (180:0:3 and 0.5);                  % cone 1: top ellipse top arc
    ...
    \draw[semithick] (-3,0) arc (-180:0:3 and 0.5);                 % cone 1: top ellipse bottom arc
    \draw[semithick] (3,0) -- (1,-5);                               % cone 1: right side
    \draw[semithick] (-3,0) -- (-1,-5);                             % cone 1: left side
