...
Reading through this thesis is like putting together Lego (hopefull as fun, too). In the background chapter the reader can peruse the contextual setting and instructions to assembly, while the in the next part, the reader is shown ready models, built by experts, for reference and inspiration. After this, the box is torn open and the bricks scattered on the floor. The reader can ponder over individual pieces and see how they they appear, feel, and stick toghether.  
