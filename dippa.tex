...
Test cases are constructed manually as is the collection of requirements, and the testing process itself. Testing is done when needed, usually after some change or update has been implemented in one or more of Wärtsilä's systems. Test cases and results are collected in documents, but no material is explicitly made reusable. 
