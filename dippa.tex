...
However, integration efforts may result in unclear responsibilities and difficulties determining if the systems cooperate and behave correctly and if any use cases are unaccounted for. There are more components that can fail and reliquishing control over systems and services may produce unexpected changes. A high number of integrations makes the task even more difficult since a single change in the system components can disrupt the whole. 

Systematic, rigorous, and automated testing is required. 

% business motivation and technical considerations 
Business processes in modern corporations rely largely on automation and operate on distributed systems and networked devices. Ensuring quality of service is essential and ensuring the delivery critical; service processes must be tested and their performance ascertained. This thesis examines the requirements of system-to-system integration testing in a real business setting.
