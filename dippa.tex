...
Tuloksena on suositus testikehyksen työnkululle sekä käytännön toteutukselle. Kehys myös haastaa yleisen käsityksen siitä, että integraatiotestaus on pelkkä ohjelmistokehityksen välivaihe, ja tarkastelee testausta jatkuvana prosessina ja aina strategiselta tasolta päivittäiseen ja komponenttitasoon. Tutkimuksen tulos viimesitelee ehyen kertomuksen ja käsikirjan automatisoiden integraationtestauksen toetuttamiseen.
