...
This chapter examines individual components and subprocesses of integration testing, based on topic areas highlighted by the models and model synthesis derived in the previous chapter. Essentially, we go through and analyze Figure \ref{fig:funnel} one box at a time, from strategy to components, and from test requirements to the test comparison oracle. 
...
\item[Use a continuous integration tool for automated test execution.] \hfill 
\\
