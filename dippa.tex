...
\begin{tabular}{ l c }
  ...
  R8 & It shall be possible to generate test loads, conduct stress tests, and measure performance. \\ \hline
  R9 & It shall be possible to generate test loads, conduct stress tests, and measure performance. \\ \hline
