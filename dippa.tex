...
This master's thesis study is divided to x parts. First, necessary background information on software integration testing, Wärtsilä's systems architecture, and information systems is presented in Chapter \ref{chapter:background}. Next, integration testing frameworks are explored by looking at existing models and a synthesis on the strategic, is given. Chapter \ref{chapter:framework} breaks down the framework into process components which are then put together in a new framework model tailored for Wärtsilä in Chapter \ref{chapter:frameworkproposal}.
