...
The distinction between unit, integration, and system tests is not always clear. Some authors consider end-to-end integration testing akin to system tests, ohters introduce component testing as intermediary between unit and integration/system tests.
