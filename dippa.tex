...
% todo measure: compare manual to automatic, benefits: customer satisaction, number of tests run, coverage achieved
% compare cost of automation to benefits, not go into detail how to do that
% compare cost of testing now and in improved version
% ddp contrast to jenkins' metric
% evalaute defect quality
% add part to evaluation about test metrics?
...
% filter, only compare parts that should be, xml makes easy

\citet{fewster1999testing} present a helpful checklist for implementing a maintainable comparator.
\begin{enumerate}
\item document, understand what is happening
\item sensible naming conventions
\item keep it simple
\item introducition, 
\item maintenance guidelines
\item standardize e.g. regexp building blocks
\item divide and conquer
\end{enumerate}

% How to add assertions to the cases.
% document, understand what is happening
% sensible naming conventions
% keep it simple
% introducition, 
% maintenance guidelines
% standardize e.g. regexp building blocks
% divide and conquer
