...
Early on in tool selection (The evaluation of which is omitted from this study. The reader is referred to excellent resources such as open source list and CI comparison list.) it became clear that not all processes could be handled by one tool but similarly not all processes required their own tool. Testing software could possible cater to different, even disparate aspects of the framework. 
