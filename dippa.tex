...
The framework is evaluated mainly on qualitative measures. A workshop was organize the communicate proposed new testing,  is done by comparisons to idealized models, interviews with Wärtsilä's experts, and observations of the framework in simulated action.

what it requires from people, integration manageres create test cases in own project, updates, responsibility
who packages suites?
