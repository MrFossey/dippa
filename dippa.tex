...
Naturally, software has to be tested to after development, but there are other reasons, too. Any change in code or specifications, the environement, testing policy or plans can act as a trigger for testing. Systematically repeating a set of tests is called regression testing. Because of their standard neature, the execution of regression stests is typically automated. 
