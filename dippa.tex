...
Models made in the design phase can be used to manage testing. A system  formalized as a finite-state machine and modeled as a network can be used to implement automated testing or test case creation, and elicit possible execution paths and ensure that the system is adequately tested. T
