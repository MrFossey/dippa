...
The graph can serve as a foundation for setting test coverage criteria and strategy (Linnenkuge & Müllerburg 1990; Benz 2008) or test case creation (Hura & Dimmich 2011). Using model-driven integration Wieczorek et al. (2010) estimated savings of 50\% in time for test generation and concretization tasks.
...
simulating unavaialbe systems and are grounded on models of the systems. 
