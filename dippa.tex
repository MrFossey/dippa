...
\citet{divall2006continuous} recommends including only one assertion per case so that final results can easily be traced back to the underlying problem, though \citet{fewster1999testing} write that some features require multiple checks verify (e.g. inserting data into a database).
