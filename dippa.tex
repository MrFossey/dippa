...
Three technical experts at Wärtsilä shared their views on the framework early on in interviews conducted by the researcher. The experts at enterprise architecutre, integrations, and testing system-to-system connections. 

The interviews, approximately an hour in length, were loosely structured and had no presumptions about the nature of the framework-to-be. The mission was to elicit Wärtsilä's requirements for integration testing including technical, functional and practical aspects. The two latter interviewees were presented findings from earlier interviews for validation and the addition of any further comments or clarifications.

The expert two integration exchange types, asynchronous and synchronous. also which protocols the framework technolgoy should support. Suggestion that test cases be geranted by capture and replay.

The second inverview three types of testing: regression in own environment before deploying to production, end-to-end in project QA, health check in production as sanity or smoke check.

In the final interview, reiterated the requirement for easy test case creation (though now specific method was endorsed) and that existing resources might be used.

The list of requirements summarizes

-asynch, synch
-protocol
-capture/replay

-health check, continuous testing
-easy test case creation, using existing resources
-end-to-end in projects, early and often
-regression 

-easy test case creation
-using existing resources
-support documents for creation 
...
table to give an example of tables. Abbreviations and Acronyms is al