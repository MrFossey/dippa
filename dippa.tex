...
The updated test framework contains an additional step for the new requirement of sending automated bug reports. The test database is now called a library since resources are not simply static values.
