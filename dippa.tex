...
\newcommand{\KEYWORDS}{integration testing, testing automation, testing framework}
\newcommand{\FKEYWORDS}{ohjelmistotestaus, automatisoitu testaus, integraatiotestaus, testikehys}
