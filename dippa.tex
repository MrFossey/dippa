...
The distinction between unit, integration, and system tests is not clear. Some authors consider end-to-end integration testing akin to system tests. Researchers like Duvall write about component testing synonymous with integration testing, while others like Pezze consider this an intermediary stage between unit and integration/system tests.
