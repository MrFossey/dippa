...
The strategy typology is designed for integration and integration testin in development, rather than integration regression testing, which limits its applicability in the Wärtsilä case if an automatically executable test case set exists or if only a few integrations are tested at a time. The strategies, however, are worth considering when changes call for testing many integrations, possibly all of them.  
