...
Researchers like \citet{zallar2001you} and \citet{kit1999integrated} criticize in particular the capture/replay paradigm where a test case is produced by recording user actions so it can be automatically reproduced and run afterwards. Maintaining the test scripts is cumbersome and as such will often be left undone rendering the test cases unusable and potentially misleading \citep{zallar2001you}. \citet{kit1999integrated} suggests to just leave out capture and simply use automation to replay.
