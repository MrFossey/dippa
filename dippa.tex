...
% -------------------------------------------------
% Placing the nodes
\node [proc] () {Test case generation};
\node [proc] () {Surrogate engine};
\node [proc] () {Running tests};
\node [proc] () {Trace collecting};
\node [proc] () {Verification};

\node [proc] () {Scheduling};
\node [proc] () {Trace transform};

\node [proc] () {Viasualization of results};
