...
The second criteria is also arguable satisfied since integration testing. Is satisfied by inputting information required by the test first and lastly deleting the information. Alternatively, unchanged information may be used, though this is a more risky approach. clearly this must be if it to be run automatically. servers must be up and there should be someone monitoring the run so that an immediate error is addressed quickyl (e.g. problem in environment configuration
