...
In the figure, the environment is made of the application container which may or may not contain parts or the whole of the system under test and in which surrogates are deployed. Again, the many intefaces in the framework are highlighted.
...
The testing frameworks or models introduced in this chapter have striking similarities and subtle connotations. All models, save for \citeauthor{huang2008surrogate}'s surrogate architecture (really only a part of the whole continous integration process), can be argued to roughly follow a three step process of generating necessary input (cases, surrogates, test data), running the test scripts, and finally verifying and comparing results. 

Since all of the models are rather pragmatic and technical, 
