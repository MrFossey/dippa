...
At the beginning of the meeting, participants were presented with a mission statement and a short introduction to the topic explaining the reasons that led to commissioning an automated testing framework study. 

Following this, the collected requirements (see Section \ref{section:requirements}) were also presented with the intent to validate the requriemetns again and elicit the most important ones. The first technical expert put 
most weight on the test generation requirement (R3). Concern centered the labour cost of creating tests and generation was crucial in making larger scale testing feasible. While the generation requirment may be argued to be not the most important component of a testing framework, it clearly sparked excitement among the participants. After all, it was the requirement that had most potential gains. 

The testing expert was more concerned if the framework actually provided any actionable results. Therefore, the automated verification step named the most important. technical expert agreed,  while the implementers underlined the importance of performance tests.
