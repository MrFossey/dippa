...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=15cm]{liu_et_al_framework.png}
    \caption{Unified testing framwork \citep{liu2009unified}}
    \label{fig:liu}
  \end{center}
\end{figure}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=15cm]{huang_et_al_framework.png}
    \caption{System architecture of surrogate \citep{huang2008surrogate}}
    \label{fig:huang}
  \end{center}
\end{figure}
