...
Issues: terminology, version contro, negative tests, code inspection, test library rather than db, deployment and pilot project, way of working, protocols, integration to bug tracker via email?, test coverage, who supports, who tests, concern over choice, 
