...
The thesis expounded on integration testing theory and frameworks. Testing frameworks in academic literature were deconstructed and analyzed and their characteristic features observed. These practical insights were combined with theoretical findings and crystallized into a new integration testing framework, which was also tailored for case company needs. The resulting framework was comprehensively evaluated through requirements analysis, heuristic appraisal, and qualitative validation by company experts. 
