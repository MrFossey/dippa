...
\begin{description}
 ...
 SoapUI & operating system, can execute tests on command
  \item[Requirement 2] \hfill \\
  schedule regular builds which execute code
  \item[Requirement 3] \hfill \\
  Write and generate cases, SoapUI is an IDE
  \item[Requirement 4] \hfill \\
  SoapUI & has monitor functionality
  \item[Requirement 5] \hfill \\
  recorded messages can be turned into cases / mock services
  \item[Requirement 6] \hfill \\
  test cases can be supplemented with assertions (quite obviously)
  \item[Requirement 7] \hfill \\
  features can be tested through web services
  \item[Requirement 8] \hfill \\
   configuring load tests based on SoapUI test cases/surrogates 
  \item[Requirement 9] \hfill \\
  configuring stress tests based on SoapUI test cases/surrogates
  \item[Requirement 10] \hfill \\
 dashboard and statistics 
\end{description}

\begin{tabular}{ l l l{3cm} }
Requirement ID & Tool & Analysis \\
Requirement 1 & SoapUI & operating system, can execute tests on command \\
Requirement 2 & Jenkins & schedule regular builds which execute code \\
Requirement 3 & SoapUI & Write and generate cases, SoapUI is an IDE \\
Requirement 4 & SoapUI & has monitor functionality \\
Requirement 5 & SoapUI & recorded messages can be turned into cases / mock services \\
Requirement 6 & SoapUI & test cases can be supplemented with assertions (quite obviously) \\
Requirement 7 & SoapUI & features can be tested through web services \\
Requirement 8 & SoapUI Sister Tool & configuring load tests based on SoapUI test cases/surrogates \\
Requirement 9 & SoapUI Sister Tool & configuring stress tests based on SoapUI test cases/surrogates \\
Requirement 10 & SoapUI Sister Tool & dashboard and statistics \\
\end{tabular}
