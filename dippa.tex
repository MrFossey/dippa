...
\tikzset{
  ...
  test/.style={draw, dotted, -latex'}
    ...
    \draw[dashed,color=gray] (-3,-5) arc (180:0:0.5 and 0.25);        % cone 1: bottom ellipse top arc
    \draw[semithick] (-3,-5) arc (-180:0:0.5 and 0.25);               % cone 1: bottom ellipse bottom arc
    \draw[semithick] (-5,0) arc (-180:0:2 and 0.5);                 % cone 1: top ellipse bottom arc
    \draw[semithick] (-5,0) -- (-4.25,-5);                             % cone 1: left side
    \draw[semithick] (-1,0) -- (-2.25,-5);                              % cone 1: right side
    ...
    \draw[semithick] (0,0) -- (4,-5);                               % cone 2: left side
    ...
    \draw[semithick] (5,0) -- (4,-5);                               % cone 3: left side
    \end{comment}
