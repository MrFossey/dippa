...
\section{Automated testing Regression testing}

Test case creation is perhaps the most time-consuming task in automated testing. Cases have to be produced based on the test plan and execution strategy, and updated when necessary. 

\section{coverage}


Tsai et al. (2001) also presented an XML-based framework for automtaed test case generation from WSDL service descriptions.
