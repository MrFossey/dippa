...
\tikzset{
  ...
  line/.style={draw, thick, -latex'},
    ...
    \node [rect, xshift=-4.00cm] (s2) {Service 2};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s2.1) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s2.2) {};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white, label={[xshift=1.0cm, yshift=0.3cm]Test}] (s2.3) {};
    
    \node [rect, right=of s2] (s3) {Service 3};
    ...
    \node [rect, right=of s3] (s4) {Service 4};
    \node [rect, xshift=0.25cm, yshift=1.25cm, fill=white] (s4.1) {};
