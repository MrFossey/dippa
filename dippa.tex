...
unit testing aggregate of techincal activities inviolved in demonstrating that an indiviudal software unit has been implemented correctly athat the code and the design of a unit are consiten and that the unit design is correct
...
functional non 
functional testing
validation the process of evaluting a software system or coponetn during or at the end of the devlopment cycle to evalut wheter it meets the customers requirments [IEEE-STD-610.12-1990]
verification process of evaluating a softwrae stystem or compoent to detmine whter theproducts of a given devlopment phase satisfy the conditions ompised ath the star that phase (pezze)[IEEE-STD-610.12-1990]
