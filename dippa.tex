...
Requirements are generally set by specifications of functionality or agreements on e.g. security policy or service level. The teting process also requires an executable set of test cases, which should be constructed with regard to the stratey scope. These can be derived (even autmatically) from formally structured models or specifications. 
