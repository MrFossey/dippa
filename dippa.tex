...
Discussion is divided into three parts. In the first the framework construct is deliberated and discussed. In the second, interesting topics and concerns are brought under light and analyzed, for instance areas that merit further study and if the common conception of integration testing is deprecated. The third part critiques and addresses the limitations of the study.
