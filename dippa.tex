...
\item In the monitor window click the button “add selected requests to test case”. Create new suite and test case in the wizard. Don’t leave any spaces in their names however!     \blacksquare    \blacksquare    \blacksquare
