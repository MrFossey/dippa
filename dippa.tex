...
This chapter examines individual components and subprocesses of integration testing, based on the models and model synthesis derived in the previous chapter. Essentially, we traverse \ref{fig:funnel} one box at a time, from strategy to components, and from test requirements to the test comparison oracle. 
