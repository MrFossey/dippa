...
The \citet{liu2009unified} model (figure \ref{fig:liu}) includes processes, objects, and agents. Based on a UML obeject, the test generator creates test cases later submitted to the exeuction engine. Surrogates facilitate software testing. After execution IBM's properietary ITCAM technology aggregates execution traces which it passes to the trace correlator for , execution engine, surrogate engineion, case execution, and execution trace collection. The surrogate generator was left out of the model.
