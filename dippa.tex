...
Researchers like \citet{zallar2001you} and \citet{kit1999integrated} criticize in particular the capture/replay paradigm where a test case is recorded so it can be automatically reproduced and run afterwards. Maintaining the test scripts is cumbersome and as such will often be left undone \citep{zallar2001you}.
