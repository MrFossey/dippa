...
The overall research problem is to devise a testing framework for automated integration tests. Here, framework refers to both the testing solution technology and libraries. Quality measures, which include functional and non-functional aspects, are described in more detail in chapter X. % TODO
...
\\
Answering the third research question involves proofing the selected frameworks. This is a sanity test of the suitabilitiy of the chosen framework, but the actual implementation of the test framework and adopting is not part of the thesis. \\
\end{adjustwidth}
...
The automated testing setup helps uncover defects and issues earlier and resolve them with fewer resources.
...
This master's thesis study is divided to x parts. First, a definition of testing frameworks, their workflows, and purpose are provided. Second, the approaches for testing automation are examined. Thirdly, the overall of the testing setup is evaluated from the perspective of defect management. 
