...
The purpose of testing is to reveal bugs in the software \citep{burnstein2003practical}. But this is a rather narrow-minded view. The testing framework should deliver results that can help developers fix the found defects. As such, though, defect management is not in the scope of the testing framework. In Wärtsilä's case there already is a bug tracker tool in use and logging new defects is left to human discretion and manual work. The framework should, however, record test execution times, system version numbers, and other contextual metadata so that testers can manage system releases and defects \citep{jenkins2008software}.
