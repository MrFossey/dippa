...
Well begun may be half done but the integration testing framework is not fully fledged and ready to be adopted for immediate use. At the very least it must be piloted in a project and streamlined to fit Wärtsilä's ways of working. Additionally, technical components must be installed and configured and made available where necessary. 

The benefits and costs related to other technical solutions, such as the one based on the monitoring solution, need to figured out first.

The thesis's recommendations and construct are applicable to Wärtsilä's case only, though the research offers more general guidelines and observations as well.
