...
This chapter examines individual components and subprocesses of integration testing, based on topic areas highlighted by the models and model synthesis derived in the previous chapter. Essentially, we go through and analyze the process levels of in integration testing, presented in Figure \ref{fig:funnel}, one area at a time, from strategy to components, and from test requirements to the test comparison oracle. 
