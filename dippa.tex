...
\item[1. What are the requirements for a testing framework in the context of Wärtsilä's integration set-up?] \hfill \\
The requirements are based on Wärtsilä's IT operation environment. This includes canonical examples of integrations, for instance between the ERP system and warehouse systems, and the ERP system and the PDM system.
 
 % 2. Compare alternatives, choose best one.
 \item[2. Which is the best integration testing framework in of the requirements among a limited set of alternatives?] \hfill \\
First, promising framework alternatives are listed after which, based on the requirements, a shortlist is composed. These frameworks are more carefully evaluated in light of the requirements, features, and public opinion. One or two alternatives are selected for the next step.
 ...
 \item[3. How can the selected framework be implemented?] \hfill \\
...
% research problem. what is a framwork? what is integration testing?
The research objevtive is . H Quality is measured and compared to set targets and requirements, the definition of which is also part of the thesis work.
