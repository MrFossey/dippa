...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Developing a framework for continuous testing in software integration in lifecycle power company}
...
As new integrations are introduced, the framework should provide a test harness that is easy to adopt. Integration test cases should have a template and their addition to the automatically executed test suites should involve a negligeable amount of work \citep{fewster1999software}.
