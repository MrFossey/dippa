...
Software development is an assembly task where components have to be laid carefully for seamless interoperation. This master's thesis examines testing these cross-component and cross-system connections within a Finnish power solutions supplier and sets out to define a practical\emph{modus operandi} for conducting automated integration testing.
...
Making this thesis has been a fun and wholly rewarding exploration of the murky waters around organizatorial regression testing. Throughout the researching and writing I was helped by many who deserve my sincere gratitude. I wish to thank Wärtsilä's technical experts for their advice and enthusiasm in the project, my frieds and peers for their useful suggestions and feedback, my thesis supervisor for her open-minded, but grounded encouragement, and finally, and in particular, my instructors for their enduring support.
