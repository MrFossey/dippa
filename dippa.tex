...
The most common way to evaluate coverage is based on control flow. Visualizing the program process flows, composed of individual statements, instructions or function calls, can help understand the program logic, features to test, and guide the design of test cases, too. \citep{burnstein2003practical} 
