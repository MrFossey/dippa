...
It is possible that integration is a misleading term. Sometimes testing is divided to unit, component, and system tests. Supposedly, a component is a combination of simple units and system tests focus on testings when all necessary components have been integrated. Testing grows with development. But the target of testing is entirely removed from this division.
