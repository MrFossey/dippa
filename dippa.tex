...
The framework requires manual setup, for instance manualling validating and storing the expected outcome, but after some initial work, Fewster was able to eke out a 7 person-week reduction compared to manual testing \citep{fewster1999software}.
