...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \draw[semithick] (0,0) arc (180:0:3 and 0.5);                  % cone 2: top ellipse top arc
    ...
    \draw[semithick] (0,0) arc (-180:0:3 and 0.5);                 % cone 2: top ellipse bottom arc
    \draw[semithick] (1,0) -- (-1,-5);                              % cone 2: right side
