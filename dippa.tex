...
Capture and playback was the target of criticism but many commercial and non-commercial tools use it and while it may not be theoretically the best option, it arguably satisfies most companies' testing requirements and needs, at least temporarily. It remains to be seen if public opinon shifts after more is known about the lifecycle of such a testing tool. The alternative, model-driven testing, requires an initial investment that is greater, but might pay off.
