...
Throughout the disuccsion the addition of new requirements was welcomed. Along with automated bug reports, one clear new requirement was version control. Running different versions of e.g. surrogates and mock services against possibly different versions of systems was requested and added as requirement eleven (R11).
