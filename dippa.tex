...
Future research might also labour over collecting, combining, and comparing strategies for test case creation. As such, experiments and proof of concepts have been given for generating test data (linnenkugel1990test, ), creating test case templates automatically \citep{bai2005wsdl}, and capture strategies (meszaros2003agile). This work should be catalogued and analyzed.
