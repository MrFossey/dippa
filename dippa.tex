...
Surrogate, or surrogate engine & A simulation apparatus that is capbale of creating and operating surrogate components which mock system services and act as stubs or drivers.  See also \emph{mock service}. \\[0.3cm]
