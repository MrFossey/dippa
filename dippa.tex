...
It is possible that \emph{integration} is a misleading term. Sometimes testing is divided to unit, component, and system tests as opposed to the traditional unit, integration, system paradigm (todo reference). Supposedly, a component is a combination of simple units and system tests focus on testing when all necessary components have been integrated. Testing grows with development. But the target of testing is entirely removed from the semantics of this division. What exactly should be tested and where should the testing focus be?
