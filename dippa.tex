...
\tikzset{
  ...
  syst/.style={base, cylinder, shape border rotate=90,  aspect=.2, minimum height=4em, text width=5em},
  file/.style={base, rectangle, shape border rotate=90, minimum height=5em, text width=3em},
