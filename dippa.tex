...
The strategy typology is designed for integration and integration testin in development, rather than integration regression testing, which limits its applicability in the Wärtsilä case if an automatically executable test case set exists. 
