...
\path [line] (prb) -- (con);
%\path [line] (ctr) -- (con);
\draw[->] ([yshift=0 * 0.0 cm]ctr.south) to [out=-10,in=-10] ([yshift=0 * 0.0 cm]con.south);
...
Qualitative evaluation of the new framework is performed through interviews with Wärtsilä's experts in a workshop, and observations of the framework in simulated action. The workshop was organized to showcase the new framework model to experts and interested parties inside Wärtsilä and to evaluate its applicability in the company. The purpose of the event was twofold: to validate and improve the framework hypothesis. Feedback both critical and supportive was elicited and suggestions for further improvement collected. The workshop event was facilitated by the author.

Two technical experts, a testing expert, and three members of a partner's infrastructure team attended the workshop. The partner members and one of the technical experts joined the meeting via remote access. The meeting agenda and purpose was explained to all participants beforehand. The discussions were recorded with the workshoppers' consent so they could be comprehensively analysed afterwards.

The most sought-after results of the workshop were the observations of people who're actually to use the framework if should it be adopted, and how do they saw creating test cases, managing test results, or otherwise maintaining the framework.
...
Throughout the disuccsion the addition of new requirements was welcomed. Along with automated bug reports, one clear new requirement was version control. Running different versions of e.g. surrogates and mock services against possibly different versions of systems was requested.
...
% add table
Harmonize framework terminology
REQ11 Version control in naming test resources (cases, environments, surrogates)
REQ12 Integration to bug tracker (email report)
Negative testing
Pilot framework in project
Align framework in Wärtsilä way of working
Code inspection as a way of testing? Can it be automated? Most IDEs have syntax control.
Test library rather than database
Update divergent links, highlight two phases
Test coverage who supports who tests, concern over test tool selection
 skipped, reusability
Reusing pre-existing resources like 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
