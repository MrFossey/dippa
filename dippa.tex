...
The application container houses system components, real and surrogate, and the surrogate generator. The surrogate genartor has a component for configuring surrogates as well as a library of functions for imitated behaviour.
