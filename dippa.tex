...
Following this, the collected requirements (see Section \ref{section:requirements}) were also presented and the most important requirements elicited. Most weight on the test generation. Concern of the labor cost this would involve. while it may be argued not to be the most important component of a testing framework, it showed the motiovation for the work. conversely the testing expert was more concerned with if the framework actually provided any actionable results. the automated verification step named the most important. technical expert agreed,  while the implementers underlined the importance of performance tests.
