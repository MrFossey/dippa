...
\tikzset{
  ...
  line/.style={draw, thick, -latex'}
    ...
    \draw[semithick] (0,0) ellipse (4 and 0.5);
    \draw[semithick] (4,0) -- (1,-7);
    \draw[semithick] (-4,0) -- (-1,-7);
    \draw[dashed,color=gray] (-1,-7) arc (180:0:1 and 0.25);
    \draw[semithick] (-1,-7) arc (-180:0:1 and 0.25);
