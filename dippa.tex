...
The testing processes described in Chapter \ref{chapter:frameworkproposal} are mapped to tools in Figure \ref{fig:structure}. Two tools were seleted: SoapUI for testing and Jenkins for continuous integration.
