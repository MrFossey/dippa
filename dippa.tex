...
The overall research problem is to devise a testing framework for automated integration tests. Here, framework refers to both the testing solution (technology) and workflow required to assure quality. Quality is measured by functional and non-functional measures and. The measurement schemei is presented in chapter X .
