...
There are a total of six processes and three objects involved in the the proposed framework, along with the system under test (SUT) and test library. These are divided into two steps, a preparatory one, and an execution step. 
