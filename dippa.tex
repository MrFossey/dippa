...
In the empirical part an essential challenge was introducing the framework into the company's way of working. Testing requires the coopereation of many individual stakeholders. In Wärtsilä's case this contribution was seen as extra work for application managers and soliciting their support was notoriopusly difficult. Here, a clearly defined framework which states what resources or contributions are needed can bring credibility and trust to the project and provide a channel for coopration.
