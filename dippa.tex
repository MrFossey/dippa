...
The first two chapters examine testing and testing need from a more general perspective. The latter two chapters investigate Wärtsilä's context of need and enumerates requirements for the framework.
