...
A testing oracle analyses testing results and applies pass/fail criteria to determine if the test was successful or not \citep{pezze2008software}. Typically, test cases contain assertions of the correct result which is compared to the actual result. The comparison can be done algorithmically if the information is in some structured form, like XML.
