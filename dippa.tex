...
A model can be used to implement automated testing or test case creation, and elicit possible execution paths and plan coverage, and ensure that the system is adequately tested. For instance, a finite-state machine is a formal model which is used...
...
Theoreticl number of states infinite Guide slection, specs are lacking, is the fsm feasible, wieczorek
