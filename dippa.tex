...
It is more common for automated test cases to contain the logic statements, or assertions, of the expected outcome compared to the actual result, than for them to be  Comparison between actual and expected results can be done algorithmically if the information is in some structured form, like XML.
