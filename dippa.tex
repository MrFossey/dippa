...
Issues: terminology, version contro, negative tests, code inspection, test library rather than db, deployment and pilot project, way of working, protocols, integration to bug tracker via email?, test coverage, who supports, who tests, concern over choice, skipped, reusability
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Who would be performing. Fit in to corporate ways of working. Most of the practical work would 
...
One of the fundamental difficulties in developing an integration testing framework is the intertwined relationship of technology and manual work involved in and around it. Clearly as a framework for \emph{automated} testing the framework is realized by algorithmic execution, but it cannot be used successfully without human intervention and maintenance. It is blurred relationship of man and machine, the concoction of technological configuration and human work process model tries the framework developer.
