...
\citep{kaner1997pitfalls} reminds that automation takes time and can slow testing down. The typical implementation workflow is to first execute a test case manually to see that it passes and then automate it. The test set becomes impotent and the simple tests find bugs at reduced rate conpared to manual testing \citep{kaner1997pitfalls}.
